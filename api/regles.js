  ...
  "elements": [
    {
      ...
      "phases": {
        "phase_de_groupes": {
          "regles": "Devine le résultat de chaque match : victoire ou match nul.",
          "points_info": "Bonne réponse = points gagnés. Bonus si tu trouves le score exact !"
        },
        "seiziemes_de_finale": {
          "regles": "Les choses sérieuses commencent : Plus tu avances, plus les points augmentent !",
          "points_info": "Trouver le vainqueur ou le nul rapporte davantage. Score exact = encore plus de points."
        },
        "huitiemes_de_finale": {
          "regles": "Nouveautés pour booster ton score.",
          "categories_predictions": [
            "Score à la mi-temps",
            "Un buteur du match",
            "Point de consolation (1 point si raté complètement)"
          ]
        },
        "quarts_demis_troisieme_place": {
          "regles": "Tout compte encore plus, les gains augmentent sur toutes les catégories !",
          "categories_predictions": ["Vainqueur", "Score final", "Score à la mi-temps", "Buteur"]
        },
        "finale": {
          "regles": "Là, c’est le jackpot, les points sont au maximum !",
          "categories_predictions": ["Vainqueur ou nul", "Mi-temps", "Score final (prolongations incluses)", "Buteur"]
        }
      },
      "bareme_points_detaille": {
        "colonnes": ["Phase de Groupes", "16èmes de finale", "8èmes de finale", "Quarts & Demis (+ 3e place)", "Finale"],
        "categories": {
          "trouver_bon_vainqueur_match_nul": [1, 2, 3, 4, 5],
          "score_final_jusqua_prolongation": [2, 4, 5, 6, 10],
          "score_mi_temps": [null, null, 2, 3, 5],
          "nom_buteur": [null, null, 1, 2, 4],
          "point_consolidation_si_zero_point": [null, null, 1, 1, 1],
          "nombre_de_matchs": [72, 16, 8, 7, 1],
          "points_max_possible_par_match": [3, 6, 11, 15, 24],
          "total_points_possible": [216, 96, 88, 105, 24]
        },
      ...
      "exemples_calcul": [
        {
          ...
          "scenario": "Un joueur pronostique sur un match de Quart de finale",
          "details": [
    ...
    },
    {
      ...
      "elements_a_predire": [
        ...
        "Le nombre de buts qu’il marquera",
    ...
    {
      "id": "jeu_bracket",
      "nom": "Jeu Bracket – Phase à élimination directe",
      "description": "Une fois les groupes terminés, devine les vainqueurs de chaque match jusqu’à la finale.",
      ...
      "conditions_egalite": {
        "etape_1": "Celui qui a le plus de prédictions correctes gagne.",
        "etape_2": "Si égalité encore, on regarde qui a le mieux prédit les équipes gagnantes, avec priorité par ordre d'importance des phases :",
        "ordre_priorite_phases": ["Finale", "Demi-finales", "Quarts", "Huitièmes"]
      }
    },
    {
      "id": "dispositions_finales",
      "nom": "Dispositions finales",
      "regles": [
